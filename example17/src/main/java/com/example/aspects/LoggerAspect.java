...
public class LoggerAspect {
    ...
    public void logException(JoinPoint joinPoint, Exception ex) {
        logger.log(Level.SEVERE, joinPoint.getSignature() +
                " An exception is thrown with the help of " +
                " @AfterThrowing which is happened due to : " + ex.getMessage());
    }
    ...
    public void logStatus(JoinPoint joinPoint, Object retVal) {
        logger.log(Level.INFO, joinPoint.getSignature() +
                " Method is successfully processed with the status " + retVal.toString());
    }
}
